...
console.log ('Starting psotion of the word "orphans":', sonnet.indexOf('orphans'));
console.log ('Number of characters in the sonnet:', sonnet.length);

const newSonnet = sonnet.replace(/winter/, 'yuletide');
const newNewSonnet = newSonnet.replace(/ the /g, ' a large ');

//printToDom(newNewSonnet, sonnet);



const sonnetDiv = document.getElementById('sonnet');
sonnetDiv.innerHTML = `<h3>${newNewSonnet}</h3>`;